...
void testInitAndDisplay() {
	std::cout << "\n~~~~ " << __func__ << "() ~~~~\n";
	enib::NumberValue<double> a{{-8.3, -4.2, -2.1, 4.3, 11.4, 17.0}, 4.5, 11.9};
	std::cout << enib::toString(a) << "\n";
	
	enib::NumberValue<float> b{{-7.5f, -3.6f, -3.0f, 5.7f, 10.3f, 14.5f}, 3.4f, 12.1f};
...
void testIncreaseValues() {
	...
	enib::NumberValue<float> c{{-7.5f, -3.6f, -3.0f, 5.7f, 10.3f, 14.5f}, 3.4f, 12.1f};
